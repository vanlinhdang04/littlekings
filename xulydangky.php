...
$userid="UR0".(mysqli_num_rows($rs)+1); //khoi tao id
date_default_timezone_set("Asia/Ho_Chi_Minh"); //set thoi gian
$date=date('Y-m-d'); //lay ngay thang
$sql="INSERT INTO `users` (`Userid`, `Username`, `Password`, `Name`, `Phone`, `Email`, `Roleid`, `Create`, `Status`) VALUES ('$userid', '$username', '$password', '$fullname', '$phone', '$email', '3', '$date', '1');";
