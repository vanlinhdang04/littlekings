...
$rs=mysqli_query($connect,"SELECT * FROM orderdetail odd inner join products pd on odd.ProductID=pd.ID WHERE Orderid='$id'");
$str="";
...
if($row['Status']==2){
	$str.='<div class="form-group">
										...
										<div class="col-md-7">
											...
											<button id="bt_status" type="button" class="btn btn-warning waves-effect" value="Confirm">Confirm</button>
										</div>
									</div>';
}
if($row['Status']==3){
	$str.='<div class="form-group">
							...
							$str.='<div class="form-group">
									...
									<div class="form-group">
										<label class="control-label col-md-5">Detail</label>
										<table class="col-md-5 col-md-offset-3 text-center">
											<thead>
