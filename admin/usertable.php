...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
            ...
            $(document).on("click","#ui_changePw",function(){
                setTimeout(function() {
                    $('#cp_username').val($("#ui_username").val());
                    $('#cp_password').focus();
                }, 1000);
                //alert("ok");
            });
		...
		function Check(){
			...
			$.ajax({
				...
				data:{admin:1,userid:$("#ui_userid").val(),username:$("#ui_username").val(),
				    name:$("#ui_fullname").val(),phone:$("#ui_phone").val(),
	...
	///////CHECK ADD USER
		function checkAdd(){
			...
			$.ajax({
					type:"post",
					url:"adduser.php",
					data:{username:$("#au_username").val(),password:$("#au_password").val(),fullname:$("#au_fullname").val(),phone:$("#au_phone").val(),email:$("#au_email").val(),role:$("#au_role").val(),status:$("#au_status").val()},
					success:function(data)
					{
						//console.log(data);
						if(data.indexOf("1")!=-1)
...
<!--                    <small>Taken from <a href="https://datatables.net/" target="_blank">datatables.net</a></small>-->
						...
						<div class="modal-body">
							<form id="ap" class="form-horizontal" onSubmit="return checkAdd()" method="post" enctype="multipart/form-data" action="adduser.php">
								...
								<div class="form-group">
									...
									<div class="col-md-7">
										<input id="au_fullname" name="Fullname" type="text" class="form-control" value="" />	
									</div>
								</div>
								<div class="form-group">
            ...
            <!-- Modal doi mat khau -->
            <div id="changePw" class="modal fade" role="form">
                <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input id="cp_username" name="Username" type="text" class="form-control" value="" readonly="true" />    
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-5">New Password</label>  
                                    <div class="col-md-7">
                                        <input id="cp_password" name="Password" type="password" class="form-control" value="" />    
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-5">Confirm Password</label>  
                                    <div class="col-md-7">
                                        <input id="cp_cfpassword" name="Password" type="password" class="form-control" value="" />    
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-offset-4 col-md-8">
