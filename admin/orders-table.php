    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html">Order Management</a>
            </div>
                            ...
                            <div class="table-responsive">
                                <table id="orders" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
										<?php
										include_once("../ketnoi.php");
										$results=mysqli_query($connect,"SELECT * FROM orders Order By Status ASC");
										$str="";
										while($row=mysqli_fetch_assoc($results)){
											...
											if($row['Status']==1){
												...
												$str.='<td><button type="button" class="btn btn-warning waves-effect">Confirm</button></td>';
											}else{
