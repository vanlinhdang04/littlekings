            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" id="c_address" name="c_address" placeholder="Example: No 273, An Duong Vuong street, District 5" value="<?php if(isset($_SESSION['address'])){ echo $row['Address'];} ?>">
                </div>
              </div>
	...
	if(isset($_SESSION['cart'])){
		foreach($_SESSION['cart'] as $k=>$sl){
			...
			// 	foreach($_SESSION[$k] as $sz=>$sl){
					...
					$str.='<tr>';
					$str.='<td>'.$row["Name"].'<strong class="mx-2"> x </strong> '.$sl.'</td>';
			...
			// }
	    		...
	    		?>
                      ...
                      <tr>
                        ...
                        <td class="text-black font-weight-bold"><strong>$<?php echo($total); $_SESSION['total']=$total; ?> </strong></td>
                      </tr>
                    </tbody>
                  </table>
